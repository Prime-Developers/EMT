...
class Date extends Tret
{
    ...
    public $rules = array(
        'years' => array(
            ...
            'pattern' 		=> '/(с|по|период|середины|начала|начало|конца|конец|половины|в|между|\([cс]\)|\&copy\;)(\s+|\&nbsp\;)([\d]{4})(-|\&mdash\;|\&minus\;)([\d]{4})(( |\&nbsp\;)?(г\.г\.|гг\.|гг|г\.|г))?/eui',
            'replacement' 	=> '$m[1].$m[2].  (intval($m[3]>=intval($m[5]))? $m[3].$m[4].$m[5] : $m[3]."&mdash;".$m[5]) . ($m[6] ? "&nbsp;гг.":"")'
        ),
